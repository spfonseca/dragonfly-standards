...
| [RESTful API Design Standard v1.1 (draft)](rest-api-design/RESTful-API-Design-Standard-v1.1.md) | Working draft of the above — holds guidelines still under elaboration (the shared batch idiom §14.7; server-assigned tenancy/ownership §13.7 with owning-org and creator provenance metadata §7.9; service short code and deployment namespace §2.11–2.12). Do not build against. | Draft |
